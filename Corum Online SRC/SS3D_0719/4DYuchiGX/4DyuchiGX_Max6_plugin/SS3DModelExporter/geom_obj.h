...
class CMeshObject : public CBaseObject
{
	...
	CLightTexture*		m_pLightTexture1;
	CLightTexture*		m_pLightTexture2;
...
//	DWORD				SetVertexNormal(VECTOR3* pv3NormalResult,VECTOR3* pv3VertexList,DWORD dwVertexNum);
	...
	void				SetLightTexture1(CLightTexture* pTex) {m_pLightTexture1 = pTex;}
	void				SetLightTexture2(CLightTexture* pTex) {m_pLightTexture2 = pTex;}
