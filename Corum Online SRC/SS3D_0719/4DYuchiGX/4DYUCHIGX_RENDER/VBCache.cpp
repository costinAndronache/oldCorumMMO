...
//	m_pVBHeap->Initialize(pRenderer->GetD3DResourceManager(),D3DFVF_VLVERTEX,D3DUSAGE_WRITEONLY,D3DPOOL_MANAGED,sizeof(D3DVLVERTEX),dwMaxVerticesNumPerVertexBuffer,dwMaxVertexBufferNum,ALAWAYS_KEEP_BUFFER);
	m_pVBHeap->Initialize(pRenderer->GetD3DResourceManager(),D3DFVF_VLVERTEX,D3DUSAGE_WRITEONLY,D3DPOOL_DEFAULT,sizeof(D3DVLVERTEX),dwMaxVerticesNumPerVertexBuffer,dwMaxVertexBufferNum,0,ALAWAYS_KEEP_BUFFER | NOT_USE_AUTO_SCHEDLUE);
//	m_pVBHeap->Initialize(pRenderer->GetD3DResourceManager(),D3DFVF_VLVERTEX,D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY,D3DPOOL_DEFAULT,sizeof(D3DVLVERTEX),dwMaxVerticesNumPerVertexBuffer,dwMaxVertexBufferNum,ALAWAYS_KEEP_BUFFER);

//	m_VBPublic.CreateVertexBuffer(pRenderer->GetD3DResourceManager(),sizeof(D3DVLVERTEX),D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY,D3DFVF_VLVERTEX, D3DPOOL_DEFAULT ,MAX_PHYSIQUE_VERTEX_NUM);
