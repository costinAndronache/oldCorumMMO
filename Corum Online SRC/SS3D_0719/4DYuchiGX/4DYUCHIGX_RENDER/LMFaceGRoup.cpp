...
BOOL CLMFaceGroup::CreateFaceGroup(CoD3DDevice* pRenderer,LPDIRECT3DDEVICE8 /*pQuadIndexList*/,VECTOR3* pv3,TVERTEX* ptv,WORD* pIndex,TVERTEX* ptLightUV1,DWORD dwFacesNum,DWORD dwFlag)
{
	BOOL		bResult = FALSE;
