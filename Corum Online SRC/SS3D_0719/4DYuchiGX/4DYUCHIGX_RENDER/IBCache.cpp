...
//	m_pIBHeap->Initialize(pRenderer->GetD3DResourceManager(),D3DUSAGE_WRITEONLY,D3DPOOL_MANAGED,dwMaxIndicesNumPerIndexBuffer,dwMaxIndexBufferNum,ALAWAYS_KEEP_BUFFER);
//	m_pIBHeap->Initialize(pRenderer->GetD3DResourceManager(),D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY,D3DPOOL_DEFAULT,dwMaxIndicesNumPerIndexBuffer,dwMaxIndexBufferNum,ALAWAYS_KEEP_BUFFER);
