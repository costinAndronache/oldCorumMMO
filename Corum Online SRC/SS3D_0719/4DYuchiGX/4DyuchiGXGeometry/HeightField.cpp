...
BOOL __stdcall CoHeightField::WriteFile(char* szFileName,DWORD /*dwFlag*/)
{
	...
	RemoveExt(szNewVCLFileName,MAX_NAME_LEN,szFileName);
...
BOOL __stdcall CoHeightField::RenderObject(DWORD dwObjIndex,DWORD dwAlpha,DWORD dwFlag)
{
	...
	DWORD							dwAppliedLightNum;
	LIGHT_INDEX_DESC*				pAppliedSpotLightIndex = NULL;
	DWORD							dwAppliedSpotLightNum;
...
BOOL __stdcall CoHeightField::SetLightVertexel(
	POINT* ptCursor,
...
BOOL __stdcall CoHeightField::GetLightVertexel(
	DWORD* pdwColor,
	POINT* ptCursor,
	VECTOR3* pv3IntersectPoint,
	DWORD /*dwViewportIndex*/
