...
DWORD CBaseObject::ReadFile(void* pFP)
{	
	DWORD	dwLen = 0;
...
BOOL __stdcall CBaseObject::ApplyWorldMatrixForPhysique(
	MATRIX4* /*pResultWorldMatrix*/,
	DWORD /*dwRefIndex*/,
	DWORD /*dwFlag*/
	)
{
...
BOOL __stdcall CBaseObject::ApplyPhysique(
	BYTE* /*pVertex*/,
	DWORD /*dwVertexSize*/,
	DWORD /*dwRefIndex*/,
	DWORD /*dwFlag*/
...
BOOL __stdcall CBaseObject::ApplyMorph(
									   VECTOR3** /*ppv3Local*/,
									   TVERTEX** /*pptv*/,
									   DWORD /*dwRefIndex*/,
									   DWORD /*dwFlag*/
...
BOOL __stdcall CBaseObject::ApplyView(
									  MATRIX4* /*pView*/,
									  DWORD /*dwRefIndex*/,
									  DWORD /*dwFlag*/
									  )
...
BOOL __stdcall CBaseObject::ApplyVertexNormal(
	BYTE* /*pVertex*/,
	DWORD /*dwVertexStartOffset*/,
	DWORD /*dwVertexSize*/,
	DWORD /*dwRefIndex*/,
	DWORD /*dwFlag*/
	)
...
BOOL __stdcall CBaseObject::ApplyMotionStatus(
	MOTION_STATUS* /*pMotionStatus*/,
	DWORD /*dwRefIndex*/,
	DWORD /*dwFlag*/
	)
{
