...
//		_asm int 3;
	...
	mdwNodeCount		=	(int(powf(4.0f, dwMaxLevel+1)) - 1) / (4 - 1);
...
/****************************************************************************
	...
	다이나믹, 스테이틱 같이 찾는다.
****************************************************************************/
void MClipper::FindRenderCandidateReculsive(
	DWORD /*dwNode*/, 
	VIEW_VOLUME &vv
	)
{
...
****************************************************************************/
void MClipper::FindNearObjectReculsive(
									   DWORD /*dwNode*/, 
									   BOUNDING_SPHERE &bs
									   )
{
...
void MClipper::CreateCandidateBuffer(DWORD /*dwMaxDynamicObjectCount*/, DWORD /*dwStep*/)
{
