...
//	BOOL				m_bApplyVelocity;
	...
	bool _dbgMarkedForDeletion;
public:
	void DbgMarkForDeletion();
	bool DbgIsMarkedForDeletion();
	bool IsCrashSource();
...
//	void				GetInterpolatedPosition( VECTOR3* pv3Pos){ *pv3Pos = m_v3CurrentRenderPos;}
	...
	BOOL				RequestAttach(CoGXObject* pFromObj,char* szObjName);
...
//	void				DetachCamera();
	...
	void						TryMoveTo( COLLISION_TEST_RESULT* pResult, VECTOR3* pTo);
	BOOL						IsLanding( void);
