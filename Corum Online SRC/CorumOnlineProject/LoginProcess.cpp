...
void LoginProcess()
{
	...
	else
	{
		...
		{
			if( !g_pNet->ConnectServer( g_pGVLogin->ServerSetInfo.pServerInfo[ g_pGVLogin->bConnectServerIndex ].szIp, g_pGVLogin->ServerSetInfo.pServerInfo[g_pGVLogin->bConnectServerIndex].port, SERVER_INDEX_AGENT ) )
			{
