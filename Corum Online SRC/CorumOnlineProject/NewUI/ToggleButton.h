...
namespace CustomUI {
	...
	public:
		...
		ToggleButton(SpriteModel spriteModel, SpriteModel pressedSpriteModel, Button::LabelModel labelModel, Rect frame);
		ToggleButton(SpriteModel spriteModel, SpriteModel pressedSpriteModel, Rect frame);
