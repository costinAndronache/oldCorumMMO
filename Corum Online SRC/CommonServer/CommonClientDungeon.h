...
enum ENUM_SKILL_CASTING_FAIL_REASON
{
	...
	SKILL_CASTING_FAIL_REASON_GET_SLAPPED,
	SKILL_CASTING_FAIL_REASON_LACK_SP,
	SKILL_CASTING_FAIL_REASON_LACK_ZODIAC_ITEM,
	SKILL_CASTING_FAIL_REASON_LACK_COOL_POINTS,
	SKILL_CASTING_FAIL_NONE_REASEON,	
	SKILL_CASTING_FAIL_REASON_OVER_RANGE
};
...
#define MAX_SKILL_LEVEL_MANUAL_INCREASE 25
...
DWORD COMMONSERVERDECLSPECIFIER cumulatedExperienceAtLevel(DWORD level, const DWORD (&expPerLevel)[MAX_LEVEL + 1]);
DWORD COMMONSERVERDECLSPECIFIER levelForCumulatedExperience(DWORD exp, const DWORD (&expPerLevel)[MAX_LEVEL + 1]);

struct COMMONSERVERDECLSPECIFIER AttackResult {
private:
	BYTE	bStatusKind;
	DWORD	dwCurUserHP;
public:
