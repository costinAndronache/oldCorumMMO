...
BEGIN_MESSAGE_MAP(CCopyItemDeleteFrame, CMDIChildWnd)
	//{{AFX_MSG_MAP(CCopyItemDeleteFrame)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()


IMPLEMENT_DYNCREATE(CCopyItemDeleteFrame, CMDIChildWnd)


//------------------------------------------------------------------------------
//	DESCRIPTION	:	-
//------------------------------------------------------------------------------
CCopyItemDeleteFrame::CCopyItemDeleteFrame()
{
	m_minWidth		= 0;
    m_minHeight		= 0; 
	m_nFrameID		= 0;
...
//	DESCRIPTION	:	-
//------------------------------------------------------------------------------
BOOL CCopyItemDeleteFrame::PreCreateWindow(CREATESTRUCT& cs) 
{
...
//	DESCRIPTION	:	-
//------------------------------------------------------------------------------
LRESULT CCopyItemDeleteFrame::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	if(message == WM_SYSCOMMAND)
	{
		if(wParam == SC_CLOSE)
		{
			CCopyItemDelete* pView = (CCopyItemDelete*)GetActiveView();
			if(pView->m_bRun)
			{
