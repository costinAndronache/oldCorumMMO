...
#define MAX_SHADOW_LIGHT_NUM_PER_SCENE		8
#define MAX_PRJIMAGE_LIGHT_NUM_PER_SCENE	8
...
#define MAX_TILE_TEXTURE_NUM			1024				
...
#define MAX_PHYSIQUE_VERTEX_NUM					4096
#define MAX_PRJMESH_INDICES_NUM					8192
...
enum UPDATE_FRAME_TYPE
{
	UPDATE_COLLISION_BONEMESH_DESC  = 0x00000001,
	UPDATE_ILLUSION_FRAME			= 0x00000002
};
enum BEGIN_RENDER_FLAG
{
	CLEAR_ZBUFFER = 0,
	CLEAR_FRAMEBUFFER = 0,
	DONOT_CLEAR_ZBUFFER	= 0x00000001,
...
enum SCHEDULE_FLAG
{
	SCHEDULE_FLAG_SCHEDULE		=	0x00000000,
	SCHEDULE_FLAG_NOT_SCHEDULE	=	0x00000001,

	SCHEDULE_FLAG_RENDER		=	0x00000000,
...
enum REDNER_TYPE
{
	...
	RENDER_TYPE_UPDATE_SHADING				=	0x00000100,
	RENDER_TYPE_NOT_DRAW					=	0x00000200,
	RENDER_TYPE_SELF_ILLUMIN				=	0x00000800,
	RENDER_TYPE_IGNORE_VIEWVOLUME_CLIP		=	0x00001000,
	RENDER_TYPE_SEND_SHADOW					=	0x00004000,
	RENDER_TYPE_RECV_SHADOW					=	0x00008000,
	RENDER_TYPE_DISABLE_ZCLIP				=	0x00010000,
	RENDER_TYPE_DISABLE_TEX_FILTERING		=	0x00020000,
	RENDER_TYPE_USE_PROJECTIONLIGHT			=	0x00040000,
	RENDER_TYPE_ENABLE_ILLUSION				=	0x00080000,
	RENDER_TYPE_SPRITE_ADD					=	0x00100000,
	RENDER_TYPE_SPRITE_MUL					=	0x00200000,
	RENDER_TYPE_SPRITE_OPASITY				=	0x00400000,
	RENDER_TYPE_USE_EFFECT					=	0x00800000
};
...
/*
#define RENDER_TYPE_ENABLE_LIGHT_ANIMATION_MASK		0x0000000f
#define RENDER_TYPE_ENABLE_CAMERA_ANIMATION_MASK	0x00000f00
#define RENDER_TYPE_ENABLE_MODEL_LIGHT_MASK			0x0000f000
#define RENDER_TYPE_UPDATE_SHADING_MASK				0x000f0000
#define RENDER_TYPE_FOR_TOOL_MASK					0xf0000000
#define RENDER_TYPE_UPDATE_SHADING_MASK_INVERSE		0xfff0ffff

#define RENDER_TYPE_NOT_DRAW_MASK					0x00f00000
#define RENDER_TYPE_FILTER_LIGHT_RANGE_MASK			0x0f000000
*/
enum SHADOW_TYPE
{
...
enum PICK_TYPE
{
	PICK_TYPE_PER_COLLISION_MESH	= 0x00000000,
	PICK_TYPE_PER_FACE				= 0x00000001,
	PICK_TYPE_PER_BONE_OBJECT		= 0x00000002,

	PICK_TYPE_SORT					= 0x00000004
};
...
struct MESH_DESC
{
	...
	VECTOR3*				pv3Direction;			// for billboard
...
struct TILE_BUFFER_DESC
{
	...
	TILE_ENTRY_DESC	tileEntryDesc[4];
...
//	float				fYScale;					// Ellipsoid, 바운딩 타원(?)용 y 케일. 1.0f이면 스피어, 2.0f정도면 x,z에 비해 y가 2배 크다.
//	float				fElasticity;				// 탄성, 0.0f이면 그냥 미끄러짐 운동, 1.0f이면 100% 반사, 그 이상이면 더 크게 반사. 일단 0으로 둔다.
...
#define TRI_FACE_SIZE			12+20+8
#define TRI_FACE_NORMAL_OFFSET	12
#define TRI_FACE_INDEX_OFFSET	32
