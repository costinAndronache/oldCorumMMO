...
set WIN10SDKDIR_LIB=C:\Program Files (x86)\Windows Kits\10\Lib\10.0.26100.0\ucrt\x86
...
set SOLUTION_LIBS=%WINSDKDIR%\Lib;%DX8SDKDIR%\lib;%VSSDKDIR%\lib\x86;%VSSDKDIR%\atlmfc\lib\x86;%WINSDKDIR%\lib;%WIN10SDKDIR_LIB%;